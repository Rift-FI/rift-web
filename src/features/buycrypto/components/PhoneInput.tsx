...
export default function PhoneInput() {
    ...
    return (
        <div className="w-full mb-10">
            ...
            <p className="text-center font-semibold flex flex-col mt-8">Phone Number
                <span className="font-light">Please enter your M-pesa phone number</span>
            </p>

            <Input inputMode="tel" type="text" placeholder="0700-000-000" className="mt-4 h-12 font-semibold" value={mpesaNumber} onChange={(e) => state?.setValue('mpesaNumber', e.target.value)} />
        </div>
    )
}