...
export default function RenderToken(props: Props){
    ...
    return (
        <div onClick={handleClick} className="w-full rounded-lg bg-accent px-3 py-2 cursor-pointer active:scale-95 flex flex-row items-center justify-between" >
            <div className="flex flex-row items-center gap-x-3" >
                <div className="w-12 h-12 relative" >
                    ...
                    {(chainQuery?.data && !token.is_native) && <img
                ...
                <div className="flex flex-col " >
                    ...
                    {
                        balanceQuery?.isLoading ? <div className="px-5 py-2 rounded-full w-fit bg-muted-foreground animate-pulse" /> : 
