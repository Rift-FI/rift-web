...
export default function SendUsd(): JSX.Element {
  const { balance } = useParams();
  const navigate = useNavigate();
  const { showerrorsnack } = useSnackbar();

  const backbuttonclick = () => {
    navigate(`/usd-asset/${balance}`);
  };
  ...
  return (
    <div id="sendasset" className="send_fiat">
      ...
      <p className="info">
        ...
        Send USD from your Airwallex balance
      </p>

      <p>
        To send USD from your Airwallex balance, simply provide the receipient's
      ...
      <p className="availablebalance">
        {formatNumber(Number(availableBalance))} USD
      </p>
