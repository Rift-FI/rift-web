...
export default function DepositLinkGenerator() {
  ...
  const onShareTg = () => {
    openTelegramLink(
      `https://t.me/share/url?url=${generatedLink}&text=Deposit asset directly to someone's wallet`
    );
  };
      ...
      <div className="deposit-link-card">
        ...
        <div className="link-section">
          <div className="link-header">
            {isGenerating ? (
              <span>Your link is generating...</span>
            ) : (
              <span>Your link is ready to share</span>
            )}
        ...
        <div className="deposit-link-info">
          <p>
            Generate a link to receive crypto payments directly to your wallet
            🚀
          </p>
        </div>
      </div>
